...
class ControlIssueController extends Controller
{
    public function index(Request $r){
        ...
        if($r->filled('control_id')) $q->where('control_id',$r->control_id);
    ...
    public function update(Request $r, ControlIssue $controlIssue){ $controlIssue->update($r->all()); return $controlIssue->fresh()->load(['control','owner']); }
